...
import 'package:moto_orbito/core/local/secure/secure_storage_client.dart';
...
void main() {
  ...
  group('InjectionContainer', () {
    test('all core singletons resolve', () async {
      ...
      expect(GetIt.instance.isRegistered<CacheService>(), isTrue);
      expect(GetIt.instance.isRegistered<SecureStorageClient>(), isTrue);
    });
  });
}
