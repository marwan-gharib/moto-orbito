...
final class AppColors {
  ...
  static const Color primaryVariantLight = Color(0xFFCC5500);
  ...
  // Dark Theme Colors
  static const Color primaryDark = Color(0xFFFF8C33);
  static const Color primaryVariantDark = Color(0xFFFF6B00);
